(function (factory) {
    ...
    async function loadSlim(engine, refresh = true) {
        ...
        await (0, plugin_easing_quad_1.loadEasingQuadPlugin)(engine, false);
