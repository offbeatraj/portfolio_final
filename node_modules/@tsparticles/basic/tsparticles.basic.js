...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define(["@tsparticles/engine", "@tsparticles/move-base", "@tsparticles/shape-circle", "@tsparticles/updater-color", "@tsparticles/plugin-hex-color", "@tsparticles/plugin-hsl-color", "@tsparticles/updater-opacity", "@tsparticles/updater-out-modes", "@tsparticles/plugin-rgb-color", "@tsparticles/updater-size"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("@tsparticles/engine"), require("@tsparticles/move-base"), require("@tsparticles/shape-circle"), require("@tsparticles/updater-color"), require("@tsparticles/plugin-hex-color"), require("@tsparticles/plugin-hsl-color"), require("@tsparticles/updater-opacity"), require("@tsparticles/updater-out-modes"), require("@tsparticles/plugin-rgb-color"), require("@tsparticles/updater-size")) : factory(root["window"], root["window"], root["window"], root["window"], root["window"], root["window"], root["window"], root["window"], root["window"], root["window"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(this, (__WEBPACK_EXTERNAL_MODULE__tsparticles_engine__, __WEBPACK_EXTERNAL_MODULE__tsparticles_move_base__, __WEBPACK_EXTERNAL_MODULE__tsparticles_shape_circle__, __WEBPACK_EXTERNAL_MODULE__tsparticles_updater_color__, __WEBPACK_EXTERNAL_MODULE__tsparticles_plugin_hex_color__, __WEBPACK_EXTERNAL_MODULE__tsparticles_plugin_hsl_color__, __WEBPACK_EXTERNAL_MODULE__tsparticles_updater_opacity__, __WEBPACK_EXTERNAL_MODULE__tsparticles_updater_out_modes__, __WEBPACK_EXTERNAL_MODULE__tsparticles_plugin_rgb_color__, __WEBPACK_EXTERNAL_MODULE__tsparticles_updater_size__) => {
