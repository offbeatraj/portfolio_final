...
const blogs = [
  ...
  },
  {
    ...
    img: "/contact/sustainability.jpeg",
...
export default function PublicationsPage() {
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      <main className="flex-grow w-full px-6 md:px-20 pt-32 pb-24 overflow-hidden space-y-32">
        <BackgroundParticles />
